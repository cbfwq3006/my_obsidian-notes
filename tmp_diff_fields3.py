...
for w,x in zip(wr,xr):
 ...
 xf={'leader':x.get('groupLeader') if source=='group' else x.get('localLeader'),'respDept':x.get('groupRespDept') if source=='group' else x.get('localRespDept'),'coordDept':x.get('groupCoordDept') if source=='group' else x.get('localCoordDept'),'measure':x.get('groupMeasure') if source=='group' else x.get('localMeasure'),'target':x.get('groupTarget') if source=='group' else x.get('localTarget'),'deadline':x.get('groupDeadline') if source=='group' else x.get('localDeadline'),'issue':x.get('issue') if source=='group' else x.get('selfIssue')}
