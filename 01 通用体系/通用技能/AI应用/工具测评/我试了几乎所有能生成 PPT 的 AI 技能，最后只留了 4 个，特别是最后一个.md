...
![[attachments/笔记同步图片/be9ee7dfcabed7e16b624d7e73e338f0_MD5.png]]
![[attachments/笔记同步图片/17fbd60953ae303ed93a00a6ab49983b_MD5.png]]
![[attachments/笔记同步图片/e4cbfec14aafb699a40372ac98022595_MD5.png]]
![[attachments/笔记同步图片/0fec15f558922efea8be6328bf4e81ad_MD5.png]]
![[attachments/笔记同步图片/efa4949954098263dc8f99c3f8973d38_MD5.png]]
![[attachments/笔记同步图片/00b17f1f9f955b6bf2335775e5bc5e44_MD5.png]]
![[attachments/笔记同步图片/695e265fbcabb5fd9afbb9d3498028d5_MD5.png]]
...
第一个:guizang-ppt-skill这个是我第一个试的。
...
第三个:Kami-design这个是我试到第三个的时候觉得"嗯,这个稳了"的。
...
第四个:ppt-master这是最后一个试的,也是让我觉得"商务场景终于有解了"的那个。
它的核心设计是AI 多角色协作流水线:Strategist 定策略 → Image_Generator 生成图片 → Executor 执行。三个角色串行工作,每页 SVG 生成前必须 re-read spec_lock.md,防止风格漂移。
