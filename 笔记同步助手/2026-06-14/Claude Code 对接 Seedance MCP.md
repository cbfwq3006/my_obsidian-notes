...
原文链接：[https://platform.acedata.cloud/documents/claude-code-mcp-seedance?category=application](https://platform.acedata.cloud/documents/claude-code-mcp-seedance?category=application)
...
使用 Seedance MCP Server 之前，需要先准备一个 Ace Data Cloud API Token。获取方式和 Claude Code VS Code 配置教程保持一致：

1.  打开 Ace Data Cloud 控制台 - 应用列表，或者识别下方二维码：
    

![[笔记同步助手/images/9d3be2c0596c7a609ddb9c284506331c_MD5.png]]

然后获取您的 API Token，留作备用。 2. 如果你尚未登录或注册，会自动跳转到登录页面；登录注册之后会自动返回当前页面。 3. 首次申请时会有免费额度赠送，可以先免费体验 Claude Code MCP 服务。

![[笔记同步助手/images/0e9b5a1d162beec5068e238287c2db57_MD5.jpg]]
...
适合你经常在多个项目里使用 Seedance MCP。配置写进本机 `～/.claude.json` 的用户级配置，之后任何项目打开 Claude Code 都能看到。
...
配置完成后，回到 Claude Code 会话直接用自然语言即可调用 Seedance：
...
| 工具 | 说明 |
| --- | --- |
| seedance\_generate\_video | 文本生成视频 |
| seedance\_generate\_video\_from\_image | 图片生成视频 |

## 相关链接

-   Seedance MCP Server（GitHub）
    
-   Claude + Seedance MCP 图文教程（claude.ai / Desktop）
...
内容效果不满意？[点此反馈](https://feedback.notebooksyncer.com/feedback/15ebc49e_1781431029473?u=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzg3MjU3NzU1OA%3D%3D%26mid%3D2247523735%26idx%3D1%26sn%3D6b1cc76676ed1c858df8af69baf3961c%26chksm%3Dcfd1500259f54212443bad4964b3acb8c2382727517498197763facb19eb0d02cc5967300711%26mpshare%3D1%26scene%3D1%26srcid%3D0614YGnsF7LpbTFH2YzhrRa6%26sharer_shareinfo%3D95dc55b38b7a7a45849e328a5891c5b7%26sharer_shareinfo_first%3D95dc55b38b7a7a45849e328a5891c5b7%23rd&s=obsidian)